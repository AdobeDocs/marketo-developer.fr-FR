...
description: appels deleteCustomObjects SOAP.
...
| customObjKeyLists->keyList->attribute | Requis | L’attribut est une paire clé/valeur utilisée pour identifier les objets personnalisés que vous souhaitez supprimer. Vous pouvez spécifier plusieurs attributs dans customObjKeyList |

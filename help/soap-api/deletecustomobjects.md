...
description: Découvrez comment utiliser deleteCustomObjects dans l’API Marketo SOAP pour supprimer des objets personnalisés par attributs clés avec les statuts DELETED, UNCHANGED, FAILED, plus XML, PHP, Java.
...
Supprime un ou plusieurs objets personnalisés et renvoie le résultat de l&#39;opération (DELETED, UNCHANGED, FAILED).
...
| customObjKeyLists->keyList->attribute | Obligatoire | L’attribut est une paire clé/valeur utilisée pour identifier les objets personnalisés que vous souhaitez supprimer. Vous pouvez spécifier plusieurs attributs dans les customObjKeyLists |

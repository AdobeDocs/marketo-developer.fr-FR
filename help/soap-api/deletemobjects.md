...
feature: SOAP
description: Marketo SOAP deleteMObjects pour supprimer l’opportunité et le rôle de la personne de l’opportunité, avec le XML de requête et de réponse, des exemples de code, retournant DELETED UNCHANGED FAILED.
...
Supprime un ou plusieurs [MObjects](marketo-objects.md) et retourne le résultat de l&#39;opération (DELETED, UNCHANGED, FAILED).

## Requête

| Nom du champ | Obligatoire / Facultatif | Description |
| --- | --- | --- |
| mObjectList->mObject->type | Obligatoire | Peut être l’une des valeurs `Opportunity` ou `OpportunityPersonRole` |
| mObjectList->mObject->id | Obligatoire | ID de l&#39;objet mobile à supprimer |

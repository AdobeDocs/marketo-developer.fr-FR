...
feature: SOAP
description: "Description des appels SOAP MObjects"
...
Cette fonction renvoie les métadonnées des MObjects standard et virtuels. Elle prend l’objet Marketo comme entrée et renvoie les attributs de champ associés à cet objet.

## Demande

| Nom de champ | Obligatoire/Facultatif | Description |
| --- | --- | --- |
| objectName | Requis | Nom du MObject pour lequel vous souhaitez obtenir des métadonnées. `objectName` peut être l’un des suivants : `ActivityRecord`, `LeadRecord`, `Opportunity`, `OpportunityPersonRole` |

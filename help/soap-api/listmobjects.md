...
title: listMObjects
feature: SOAP
description: Référence pour l’appel SOAP listMObjects qui renvoie des noms d’objet Marketo pour descriptionmobjects, avec une requête et une réponse XML et un exemple de code.

...
title: "listMObjects"
feature: SOAP
description: "listMObjects appels SOAP"
...
Cette fonction renvoie les noms des objets Marketo qui peuvent être utilisés comme entrée dans le [descriptionMObjects](./describemobject.md) pour les opérations de découverte de schémas.

## Demande

_Il n’y a aucune entrée pour cette API_

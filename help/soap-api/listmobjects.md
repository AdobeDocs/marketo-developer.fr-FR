...
title: listMObjects
feature: SOAP
description: listMObjects SOAP appels
...
Cette fonction renvoie les noms des objets Marketo qui peuvent être utilisés comme entrée dans la fonction [décrireMObjects](./describemobject.md) pour les opérations de découverte de schémas.

## Demande

_Il n’y a aucune entrée dans cette API_

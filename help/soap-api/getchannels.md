...
title: getChannels
feature: SOAP
description: Découvrez comment Marketo SOAP getChannels récupère les statuts de progression du canal, les numéros d’étape et les indicateurs de succès, avec des exemples XML de requête et de réponse.
...
Cette fonction récupère les informations suivantes sur une configuration de canal dans Marketo :

- Statuts de progression
- Numéro d&#39;étape de chaque statut de progression
- Si un statut de progression spécifique a été défini comme succès

Vous pouvez obtenir des informations sur tous les canaux ou spécifier une liste spécifique de canaux

## Requête

| Nom du champ | Obligatoire / Facultatif | Description |
| --- | --- | --- |
| tag->values->stringItem | Facultatif | Liste des canaux que vous souhaitez interroger. Si `<tag>` est omis, vous recevrez des informations sur tous les canaux |

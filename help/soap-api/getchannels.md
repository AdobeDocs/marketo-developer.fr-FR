...
Cette fonction récupère les informations suivantes sur un canal configuré dans Marketo :

- Statuts de progression
- Numéro de chaque état de progression
- Si un état de progression spécifique a été défini comme succès

...
title: getTags
feature: SOAP, Tags
description: Marketo SOAP getTags récupère les types de balises et les valeurs hors canal avec des filtres de balises facultatifs, ainsi que des champs de requête et des exemples de réponse de requête XML complets.
...
Cette fonction récupère les informations suivantes sur les balises hors canal configurées dans Marketo.

- Type de variable
- Valeur de la balise

Vous pouvez obtenir des informations sur toutes les balises non liées aux canaux ou spécifier une liste spécifique de balises et/ou de valeurs.

## Requête

| Nom du champ | Obligatoire / Facultatif | Description |
| --- | --- | --- |
| tagList->tag | Facultatif | Liste des balises sur lesquelles vous souhaitez effectuer une requête. Chaque balise peut avoir un type et un tableau de valeurs sous forme de chaînes. Si `<tagList>` est omis, vous recevrez des informations sur tous les canaux |

...
title: getTags
feature: SOAP, Tags
description: getTags SOAP appels
...
Cette fonction récupère les informations suivantes sur les balises non-canal configurées dans Marketo.

- Type de variable
- Valeur de balise

Vous pouvez obtenir des informations sur toutes les balises non-canal ou spécifier une liste spécifique de balises et/ou de valeurs.

## Demande

| Nom de champ | Obligatoire/Facultatif | Description |
| --- | --- | --- |
| tagList->tag | En option | Liste des balises que vous souhaitez interroger. Chaque balise peut avoir un type et un tableau de valeurs sous forme de chaînes. Si `<tagList>` est omis, vous recevrez des informations sur tous les canaux. |

...
- Vous devez sélectionner une autorisation de rôle de deux groupes différents lors de la création du rôle utilisateur pour [Service personnalisé](https://experienceleague.adobe.com/fr/docs/marketo/using/product-docs/administration/additional-integrations/create-a-custom-service-for-use-with-rest-api) pour l’API REST :
   1. Autorisation &quot;Accéder aux utilisateurs&quot; du groupe [Accès à l’administrateur](https://experienceleague.adobe.com/fr/docs/marketo/using/product-docs/administration/users-and-roles/descriptions-of-role-permissions)
   1. &quot;Accès à l’API User Management&quot; à partir du groupe [Access API](https://experienceleague.adobe.com/fr/docs/marketo/using/product-docs/administration/users-and-roles/descriptions-of-role-permissions)

...
<table>
  ...
  <tr>
      ...
      <td>Le serveur a rencontré une condition inattendue qui l’a empêché de satisfaire la requête.  Dans Marketo, cela peut inclure des URL de requête d’API REST incorrectement formées.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Le nombre d'appels aujourd'hui a dépassé le quota de l'abonnement (réinitialisé tous les jours à 00h00 CST).&gt;Votre quota se trouve dans le menu Admin-&gt;Services Web. Vous pouvez augmenter votre quota par l'intermédiaire de votre gestionnaire de compte.</td>
    </tr>
    <tr>

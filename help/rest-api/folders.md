...
[Référence des points de fin de dossiers](https://developer.adobe.com/marketo-apis/api/asset/#tag/Folders)
...
Les dossiers de requête suivent les types de requête standard pour les ressources de [par id](https://developer.adobe.com/marketo-apis/api/asset/#tag/Folders/operation/getFolderByIdUsingGET), [par nom](https://developer.adobe.com/marketo-apis/api/asset/#tag/Folders/operation/getFolderByNameUsingGET), et [navigation](https://developer.adobe.com/marketo-apis/api/asset/#tag/Folders/operation/getFolderUsingGET).
...
Les mises à jour des dossiers sont effectuées par le biais d’un point de terminaison distinct, ainsi que par la description, le nom et `isArchive` sont des paramètres facultatifs pour la mise à jour. If `isArchive` est modifié par une mise à jour. Le dossier est alors archivé, s’il est défini sur true ou non archivé, s’il est remplacé par false, dans l’interface utilisateur de Marketo. Les programmes ne peuvent pas être mis à jour avec cette API.
